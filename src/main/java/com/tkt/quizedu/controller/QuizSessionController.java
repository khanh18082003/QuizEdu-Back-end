...
@Tag(name = "QuizSession Management", description = "APIs for QuizSession registration and management")
public class QuizSessionController {
    ...
    public SuccessApiResponse<Boolean> joinQuizSession(@RequestBody JoinQuizSessionRequest joinQuizSessionRequest) {
        Boolean response = quizSessionService.joinQuizSession(joinQuizSessionRequest.accessCode(),
                joinQuizSessionRequest.studentId());
